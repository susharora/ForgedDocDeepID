#!/usr/bin/env python3
"""
Stage 48 — document-stem clustered bootstrap for final 1330-image TruFor results.
...
def main():
    ...
    out_csv = (
        ANALYSIS_ROOT
        / "48_final1330_cluster_bootstrap_CI.csv"
    )
    ...
    summary = {
        ...
        "interpretation":
            (
                "All 1330 images in the frozen attack population "
                "are included. Cluster-bootstrap intervals account "
                "for repeated observations sharing a document stem."
            ),
    ...
    summary_path = (
        ANALYSIS_ROOT
        / "48_final1330_cluster_bootstrap_summary.json"
    )
